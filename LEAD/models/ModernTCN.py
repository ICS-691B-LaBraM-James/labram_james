...
class ModernTCN(nn.Module):
    def __init__(self, task_name,patch_size, patch_stride, stem_ratio, downsample_ratio, ffn_ratio, num_blocks, large_size, small_size, dims, dw_dims,
                 ...
                 subtract_last=False, freq=None, seq_len=512, c_in=7, individual=False, target_window=96, class_drop=0.1,class_num=10):
        ...
        with torch.no_grad():
            ...
            feat = self.forward_feature(dummy)
...
class Model(nn.Module):
    def __init__(self, configs):
        ...
        self.drop_head = configs.dropout
        ...
        self.model = ModernTCN(task_name=self.task_name,
                               ...
                               small_size=self.small_size, dims=self.dims,
