...
class Exp_Finetune(Exp_Basic):
    ...
    def train(self, setting):
        ...
        # exact path to pretrain model checkpoint (only one checkpoint)
        pretrain_model_path = self.args.checkpoints_path
        ...
        if "n_averaged" in pretrained_state_dict.keys():  # search for the key n_averaged to see if it is a swa model
