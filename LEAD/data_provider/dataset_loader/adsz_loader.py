...
def get_id_list_adsz(args, data_list: np.ndarray, a=0.6, b=0.8):
    '''
    Loads subject IDs for all, training, validation, and test sets for ADSZ data
    Args:
        args: arguments
