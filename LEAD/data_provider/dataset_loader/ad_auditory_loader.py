...
def get_id_list_auditory(args, data_list: np.ndarray, a=0.6, b=0.8):
    """
...
class ADAuditoryLoader(BaseLoader):
    """
    Memmap-based loader for AD-Auditory.
    ...
    def _get_id_lists(self, args, data_list: np.ndarray, a: float, b: float):
        ...
        return get_id_list_auditory(args, data_list, a, b)
