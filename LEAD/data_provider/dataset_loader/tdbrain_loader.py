...
def get_id_list_tdbrain(args, data_list: np.ndarray, a=0.6, b=0.8):
    '''
    Loads subject IDs for all, training, validation, and test sets for TDBRAIN data
    Args:
        args: arguments
