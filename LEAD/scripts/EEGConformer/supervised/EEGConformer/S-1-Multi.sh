...
# ADFTD
python -u run.py --method EEGConformer --task_name supervised \
--is_training 1 --root_path ./dataset/L400/ --model_id S-ADFTD-Multi --model EEGConformer --data MultiDatasets \
...
# CNBPM
python -u run.py --method EEGConformer --task_name supervised \
--is_training 1 --root_path ./dataset/L400/ --model_id S-CNBPM-Multi --model EEGConformer --data MultiDatasets \
...
## APAVA
python -u run.py --method EEGConformer --task_name supervised \
--is_training 1 --root_path ./dataset/L200/ --model_id S-APAVA-Multi --model EEGConformer --data MultiDatasets \
...
# ADFSU
python -u run.py --method EEGConformer --task_name supervised \
--is_training 1 --root_path ./dataset/L100/ --model_id S-ADFSU-Multi --model EEGConformer --data MultiDatasets \
...
# ADSZ
python -u run.py --method EEGConformer --task_name supervised \
--is_training 1 --root_path ./dataset/L100/ --model_id S-ADSZ-Multi --model EEGConformer --data MultiDatasets \
